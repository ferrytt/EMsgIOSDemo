...
- (void)viewDidLoad
{
    ...
    [backButton setTitleColor:RGBACOLOR(245, 245, 245, 1) forState:UIControlStateNormal];
    [backButton setTitleColor:RGBACOLOR(245, 245, 245, 1) forState:UIControlStateHighlighted];
    ...
    if (_isSendLocation) {
        ...
        [sendButton setTitleColor:BASE_GREEN_COLOR forState:UIControlStateHighlighted];
