...
- (void)setupSubviews
{
    ...
    [self.styleChangeButton setImage:[UIImage imageNamed:@"ToolViewInputVoice"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"ToolViewInputVoice"] forState:UIControlStateHighlighted];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"ToolViewKeyboard"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"TypeSelectorBtn_Black_ios7"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"TypeSelectorBtn_Black_ios7"] forState:UIControlStateHighlighted];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"ToolViewEmotion"] forState:UIControlStateHighlighted];
...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    _inputTextView.placeHolder = kInputTextPlaceHolder;
    ...
    [self.recordButton setBackgroundImage:[UIImage imageWithColor:RGBACOLOR(242, 242, 245,1)]
                              forState:UIControlStateNormal];
    [self.recordButton setTitle:kInputVoicePlaceHolder forState:UIControlStateNormal];
    [self.recordButton setTitleColor:QYQCOLOR(68, 68, 68) forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[UIImage imageWithColor:QYQCOLOR(195, 196, 199)] forState:UIControlStateHighlighted];
    self.recordButton.layer.borderWidth = 0.5;
    self.recordButton.layer.cornerRadius = 5;
    self.recordButton.layer.borderColor = QYQCOLOR(179, 181, 186).CGColor;
